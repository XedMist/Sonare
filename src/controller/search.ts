...
// Unified search endpoint - returns all results in a single sorted list
searchController.get("/unified", validate("query", UnifiedSearchQuerySchema), requirePermission(Capability.READ, "tracks"), async (c) => {
